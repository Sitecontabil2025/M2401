...
?>
<?php $json = json_decode(get_json("https://sitecontabil.com.br/json/?db=sc_mod_documentos")); ?>
<?php $json_ler = json_decode(get_json("https://sitecontabil.com.br/json/?db=sc_mod_documentos&id=$id")); ?>
