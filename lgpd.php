<?php
$titulo_pagina = "Lei Geral de Proteção de Dados";
$descricao_pagina = "Venha fazer uma parceria de sucesso!";
?>

<?php include_once('header.php'); ?>

    <div class="seg seg-s6 bkg py-8 pos">
            ...
            <?php if (isset($whatsapp) || isset($email)) : ?>
                <div class="col-lg-5">
                    ...
                    <form id="solicitar">
                        ...
                        <?php if (isset($email)) : ?>
                            <button id="enviar_email" class="bt bt-b2 mt-1">Enviar por e-mail</button>
                        <?php endif ?>

                        <?php if (isset($whatsapp)) : ?>
                            <button id="enviar_whatsapp" class="bt bt-b2 mt-1">Enviar por WhatsApp</button>
                        <?php endif ?>
                    </form>
                </div>
